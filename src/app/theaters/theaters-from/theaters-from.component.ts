...
@Component({
  selector: 'app-theaters-from',
  standalone: true,
  imports: [MatFormFieldModule, ReactiveFormsModule, MatInputModule, MatButtonModule, RouterLink, MapComponent],
  templateUrl: './theaters-from.component.html',
  styleUrl: './theaters-from.component.css'
})
export class TheatersFromComponent implements OnInit {
